...
const NewArrivalsCard = ({ product, onAddToCart }) => {
        ...
        >
            ...
            `}
                ...
                <div className="flex flex-col gap-1 sm:gap-2 z-10">
                    {/* New Badge - Always shown for new arrivals */}
                    <div className="absolute right-0  bg-red-500 text-white text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded">
                        <span>New</span>
                    </div>
                    {hasDiscount && (
                        <div className="absolute top-2 sm:top-3 left-2 sm:left-3  bg-[#5c2d16] text-white text-xs font-bold px-1.5 py-0.5 sm:px-2 sm:py-1 rounded">
