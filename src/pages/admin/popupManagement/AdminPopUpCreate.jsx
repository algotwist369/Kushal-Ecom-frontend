...
const AdminPopUpCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const createPromise = api.post('/popups', submitData);
            
            toast.promise(
                createPromise,
                {
                    loading: 'Creating popup...',
            ...
            setError(err.response?.data?.message || 'Failed to create popup. Please try again.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900">Create New PopUp</h1>
                    <p className="text-gray-600 mt-2">Create a promotional popup for your store</p>
                </div>
