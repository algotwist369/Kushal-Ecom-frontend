...
import { getCouponById, updateCoupon } from '../../../services/adminService';
...
const AdminCouponEdit = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const [couponRes, productsRes, categoriesRes] = await Promise.all([
                getCouponById(id),
            ...
            if (couponRes.success) {
                ...
                setFormData({
                    ...
                    applicableProducts: coupon.applicableProducts?.map(p => typeof p === 'object' ? p._id : p) || [],
                    applicableCategories: coupon.applicableCategories?.map(c => typeof c === 'object' ? c._id : c) || []
                });
            } else {
            ...
            toast.error('Error loading coupon data');
            navigate('/admin/coupons');
        }
        setLoading(false);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const updatePromise = updateCoupon(id, payload);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-[#5c2d16]">Edit Coupon</h1>
